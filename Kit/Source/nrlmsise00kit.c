/* This file is a repackaging of nrlmsise-00.c, nrlmsise-00_data.c, and */
/* nrlmsise-00.h, with a wrapper to interface with 42.                  */
...
/* GTS3C */
static double DiffDens; /* This is never computed, never used */
...
/* These arrays have been cut/paste from nrlmsise-00_data.c by ETS    */
/* ------------------------------------------------------------------- */
/* ------------------------ BLOCK DATA GTD7BK ------------------------ */
/* ------------------------------------------------------------------- */
 ...
 */
   ...
   /**** temperature at altitude ****/
   DiffDens = densm(input->alt, 1.0, 0, &tz, mn3, zn3, meso_tn3, meso_tgn3, mn2, zn2, meso_tn2, meso_tgn2);
   output->t[1]=tz;
...
#define R2D (57.2957795130823)
      ...
      /* See NOTES ON INPUT VARIABLES above */
      Input.lst = Input.sec/3600.0+Input.g_long/15.0;
      Input.f107A = F10p7;
      Input.f107 = F10p7;
      Input.ap = AP;
      for(i=0;i<7;i++) ApArray.a[i] = AP;
      Input.ap_a = &ApArray;

      /* Run the model.  See OUTPUT notes about d[5] above */
